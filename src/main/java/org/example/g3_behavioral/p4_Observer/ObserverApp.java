...
public class ObserverApp {
     ...
     * <p>
     * ApplicationListener (Observer): Интерфейс, который вы реализуете, чтобы слушать события.
     * Когда событие происходит, метод onApplicationEvent() будет вызван.
     * <p>
     * ApplicationEventPublisher (Subject) : Интерфейс, который вы используете для публикации событий.
